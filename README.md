...
|---|---|---|
| **Mobil / Frontend** | React Native + Expo (SDK 54), TypeScript | Tip güvenliği ve tek kod tabanıyla iOS/Android desteği — Type safety and a single codebase for iOS/Android |
...
Fiziksel cihazınızda test etmek için **Expo Go** uygulamasını kullanabilir, telefonunuzun bilgisayarınızla **aynı Wi-Fi ağına** bağlı olduğundan emin olabilirsiniz.
To test on a physical device, use the **Expo Go** app and make sure your phone is on the **same Wi-Fi network** as your computer.
...
- [ ] Cihaz durumu için push bildirimleri / Push notifications for device status
---
